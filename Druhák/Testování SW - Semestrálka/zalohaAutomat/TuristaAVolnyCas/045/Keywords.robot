...
Zaloguj a Zkontroluj
    [Arguments]  ${ButtonTurista}  ${StrankaTurista}  ${ButtonSuvenyr}  ${StrankaSuvenyr}
    ...
    Element Should Be Visible  ${ButtonSuvenyr}

    Click Element  ${ButtonSuvenyr}

    Location Should Contain  ${StrankaSuvenyr}
