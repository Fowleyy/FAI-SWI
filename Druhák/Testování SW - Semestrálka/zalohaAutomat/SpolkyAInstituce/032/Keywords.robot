...
Zaloguj a Zkontroluj
    [Arguments]  ${ButtonSpolky}  ${StrankaSpolky}  ${ButtonSkola}  ${StrankaSkola}  ${ButtonWeb}  ${StrankaWeb}
    ...
    Element Should Be Visible  ${ButtonSkola}

    Click Element  ${ButtonSkola}

    Location Should Contain  ${StrankaSkola}
