...
Kontroluj
    ...
    ...  ${Input_prijmemi}  ${Input_tel}  ${Value_NevalidniEmail}  ${Value_Validniheslo}
    ...  ${Value_Validnijmeno}  ${Value_Validniprijmeni}  ${Value_ValidniTelefon}  ${SpatneUdaje}
    ...
    Input Text  ${Input_hesloVerify}  ${Value_Validniheslo}
