...
Kontroluj
    [Arguments]  ${ButtonTurista}  ${StrankaTurista}  ${ButtonPrehrada}  ${StrankaPrehrada}  ${ButtonDuha}  ${StrankaDuha}
    ...
    Element Should Be Visible  ${ButtonPrehrada}

    Click Element  ${ButtonPrehrada}

    Location Should Contain  ${StrankaPrehrada}
