...
Kontroluj
    [Arguments]  ${ButtonTurista}  ${StrankaTurista}  ${ButtonLodicka}  ${StrankaLodicka}
    ...
    Element Should Be Visible  ${ButtonLodicka}

    Click Element  ${ButtonLodicka}

    Location Should Contain  ${StrankaLodicka}
