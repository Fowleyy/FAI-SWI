...
Kontroluj
    [Arguments]  ${ButtonTurista}  ${StrankaTurista}  ${ButtonVlacek}  ${StrankaVlacek}
    ...
    Element Should Be Visible  ${ButtonVlacek}

    Click Element  ${ButtonVlacek}

    Location Should Contain  ${StrankaVlacek}
