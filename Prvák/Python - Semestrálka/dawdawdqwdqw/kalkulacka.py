...
def trojuhelnik_ui():
    ...
    try:
        ...
        # Calculate the area directly using the lengths of sides a, b, and c
        # as it's not feasible to ask for the height in this context
        s = (a + b + c) / 2
        area = math.sqrt(s * (s - a) * (s - b) * (s - c))
        print("Obsah trojuhelniku je:", area)
    except ValueError as e:
        print("Chyba:", e)
